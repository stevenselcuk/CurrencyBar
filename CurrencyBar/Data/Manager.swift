...
class Manager: ObservableObject {
    ...
    @Published var checkInterval: Float = storage.optionalFloat(forKey: "checkInterval") ?? 1 * 60 * 60
    @Published var launchAtLogin: Bool = storage.bool(forKey: "launchAtLogin")
